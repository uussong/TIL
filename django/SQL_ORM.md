...
2. user 레코드 생성
   ...
   ```python
   # orm
   User.objects.create(first_name="유송", last_name="정", age=29, country='경기도', phone='010-9876-5432', balance=3000000)
   ```

   ```sql
   -- sql
   INSERT INTO users_user values(102, '싸피', '김', 20, '서울', '010-1234-5678', 10000000);
   ```
